...
[gitpod]: https://gitpod.io/#https://github.com/eattherichs/foundry-template
[gitpod-badge]: https://img.shields.io/badge/Gitpod-Open%20in%20Gitpod-FFB45B?logo=gitpod
[gha]: https://github.com/eattherichs/foundry-template/actions
[gha-badge]: https://github.com/eattherichs/foundry-template/actions/workflows/ci.yml/badge.svg
...
- [Forge](https://github.com/foundry-rs/foundry/blob/master/forge): compile, test, fuzz, debug and deploy smart
  contracts
- [PRBTest](https://github.com/eattherichs/prb-test): modern collection of testing assertions and logging utilities
...
Click the [`Use this template`](https://github.com/eattherichs/foundry-template/generate) button at the top of the page to
create a new repository with this repo as the initial state.

Or, if you prefer to install the template manually:

```sh
forge init my-project --template https://github.com/eattherichs/foundry-template
cd my-project
